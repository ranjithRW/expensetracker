...
const Expense = () => {
  ...
  const deleteExpense = async (id) => {
    ...
    try {
      ...
      console.error("something went wrong to delete expense details", error.response?.data?.message || error.message);
    }
  }
  ...
  const handleDownloadExpenseDetails = async () => {
    ...
    try {
      ...
      console.error("something went wrong to download expense", error);
    }
  }
  ...
  return (
    <DashboardLayout activeMenu="Expense">
      <div className="my-5 mx-auto">
        ...
        >
          <DeleteAlert
            content="Are you sure you want to delete this expense file...?"
